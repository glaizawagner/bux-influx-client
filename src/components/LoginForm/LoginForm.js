          ...
          <section className="FormLogin">
            ...
            >
              ...
              <div className='user_name'>
                ...
                <input name='user_name'  id='LoginForm__user_name' defaultValue ='test' placeholder="test" required/>
              </div>
              <div className='password'>
                <label htmlFor='LoginForm__password'>Password</label>
                <input name='password' type='password'  id='LoginForm__password' defaultValue = 'password' placeholder="password" />
              </div>
              <div>
